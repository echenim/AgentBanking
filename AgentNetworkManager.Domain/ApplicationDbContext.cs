...
namespace AgentNetworkManager.Domain
{
             ...
             string, ApplicationUserLogin, ApplicationUserRole, ApplicationUserClaim>
    {
        ...
        //public DbSet<AspNetUserRoles> MapUserToRoleses { get; set; }
        public DbSet<Member> Members { get; set; }

        public DbSet<Organogramm> Structure { get; set; }
        public DbSet<Expense> AgentExpens { get; set; }
        public DbSet<WalletStatus> AgentCurrentWalletStatus { get; set; }
        public DbSet<LastTransaction> LastTransactions { get; set; }
        public DbSet<FundWallet> FundWallets { get; set; }

        public DbSet<MemberWithAgentRole> MemberWithAgentRoles { get; set; }
